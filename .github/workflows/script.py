...
for file_name in file_names:
    ...
    if last_access_index < last_modify_index:
        ...
        if f'/home/runner/work/{repo}/{repo}/.git/' not in file_name:
...
step_df.to_csv('optimizing-ci-builds-ci-analysis/steps.csv')
info_df.to_csv('optimizing-ci-builds-ci-analysis/files.csv')